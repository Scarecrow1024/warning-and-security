...
use app\modules\warning\models\Factory;
...
class ErrorController extends BaseController
{
	...
	**/
    ...
    public function actionApi(){
    	...
    	$rs=curl_init();
    	$json='{"token":1003,"error":"error","type":0}';
    	//$post=json_decode($json,true);
        $url="http://local.sec.com/warning/error/post";
        curl_setopt($rs,CURLOPT_URL,$url);
        //post数据来源
        curl_setopt($rs,CURLOPT_REFERER,"http://local.sec.com/warning/error/api");
